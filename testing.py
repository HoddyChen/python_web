...
class test_126(TaskSet):
    ...
    def test_baidu(self):
        ...
        # r是包含所有响应内容的一个对象
        r = self.client.get("/copyorder?class=copyorder&ukid=60c182032841306eae1688119160830d&f2=235532&f5=6bd789b82d83e779101f37ce01a6f6c8&f10=869dd820b7d642fded2fcb82e079b791", timeout=30, headers=header)
