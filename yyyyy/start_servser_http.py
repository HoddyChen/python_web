...
if __name__ == "__main__":
    ...
    #     "certfile": os.path.join(os.path.abspath("/home/ssl/"), "fullchain.pem"),
    #     "keyfile": os.path.join(os.path.abspath("/home/ssl/"), "privkey.pem"),
    # }, xheaders=True)#https,
    if StartType == "listen":
        # 单线程
        ...
        if not settings['debug'] and Htype == True:
            ...
            tornado.process.fork_processes(2)# 0 表示按 CPU 数目创建相应数目的子进程
